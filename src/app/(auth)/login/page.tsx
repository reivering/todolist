    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-100 mb-2">Welcome back to toodoloo</h1>
          <p className="text-slate-400 text-sm sm:text-base">Sign in to continue</p>
        </div>
